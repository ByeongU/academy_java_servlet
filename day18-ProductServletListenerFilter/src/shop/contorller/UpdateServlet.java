 ...
 * ---------------------------------------------------<br/>
 * GET<br/>
 * 1. detail.jsp 에서 [수정] 링크를 통해 들어온 요청<br/>
 * => 현재 상세보기 하고 있던 제품을 조회를 하여<br/>
 * => 수정할 수 있는 화면인 update.jsp 로 전달<br/>
 * => 수정을 위한 화면 이동(이미 있는 화면 요청)<br/>
 * => 그래서 GET 요청으로 처리함.<br/>
 * 
 * ---------------------------------------------------<br/>
 * POST<br/>
 * 2. update.jsp 에서 수정된 내용을<br/>
 *    [저장] 버튼을 통해 들어온 요청을 처리<br/>
 * => 변경된 입력 내용을 실제 update 쿼리를 수행하여 DB에 영구 반영<br/>
...
public class UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request
		...
		try {
			// 2. (4) 조회된 정보를 request 추가
			Product found = warehouse.get(product);
			
			// 2. (5) request 에 수정 제품 정보 속성 추가
